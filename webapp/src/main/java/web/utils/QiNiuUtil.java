...
public class QiNiuUtil {
    ...
    public static boolean upload(String localFilePath, String key, boolean override){
        ...
        //...生成上传凭证，然后准备上传
        System.out.println("打印七牛云配置文件：ak:"+QiNiuConfig.getInstance().getAccessKey()+"sk:"+QiNiuConfig.getInstance().getSecretKey());
...
//    }
    ...
    public static void main(String[] args) throws IOException {
        int size = 60;
//        boolean flag = upload("C:\\Users\\CUIPRO\\Desktop\\javaweb\\WebCommunication\\webapp\\target\\webapp\\images\\users\\ico\\5dbe9cc1974a4e30b40fcf9c46abb02f.jpeg", "test", true);
        String flag = fileUrl("test");
